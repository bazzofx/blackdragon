import os
import unittest
from tls import SamuraiReportParser

class TestTLSReportParser(unittest.TestCase):
    def setUp(self):
        # Locate report templates relative to this test script
        self.script_dir = os.path.dirname(os.path.abspath(__file__))
        self.samurai_report_path = os.path.join(self.script_dir, 'samuraiTLSReport.html')
        self.nec_report_path = os.path.join(self.script_dir, 'necswsReport.html')
    ...
    def test_samurai_report_parsing(self):
        ...
        # In samuraiTLSReport.html, TLSv1 and TLSv1.1 are supported and vulnerable
    ...
    def test_nec_report_parsing(self):
        ...
        # In necswsReport.html, TLSv1 and TLSv1.1 are disabled and must not be marked as supported or vulnerable
